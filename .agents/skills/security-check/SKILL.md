...
The pre-push hook always runs markdownlint in its dedicated Docker container. If every pushed file is Markdown, it skips the other pre-push checks. Unknown or mixed diffs use the full safe path.
